        ...
        config = function()
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    map('<leader>sD', require('telescope.builtin').lsp_type_definitions,
                        'Search Type Definitions')
                    map('<leader>sd', require('telescope.builtin').lsp_document_symbols,
                        'Search Document Symbols')
                    map('<leader>sy', require('telescope.builtin').lsp_dynamic_workspace_symbols,
                        'Workspace Symbols')
